                ...
                <div className="ResourceFiles">
                    ...
                    <ul>
                        ...
                        {this.state.resources ? this.state.resources.map(resource => 
                            <li> 
                                <img className="icons" src="https://s3.amazonaws.com/iconbros/icons/icon_pngs/000/000/288/original/file-empty.png?1510679782" width="10" height="13" alt="file icon"/>
